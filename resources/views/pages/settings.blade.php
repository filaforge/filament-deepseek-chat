    ...
    <x-filament::section>
        ...
        <form wire:submit.prevent="save" class="space-y-4">
            <div>
                ...
                <textarea id="apiKey" wire:model.defer="apiKey" rows="5" placeholder="Paste your DeepSeek API key here" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 p-2 text-sm"></textarea>
            </div>
